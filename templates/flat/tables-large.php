...
<head>
	...
	<script src="js/plugins/datatables/extensions/dataTables.fixedColumns.min.js"></script>
	<script src="js/plugins/datatables/extensions/dataTables.fixedHeader.min.js"></script>
	...
	<div class="col-sm-12">
		<div class="box box-bordered box-color green">
			...
			<div class="box-content nopadding">
				...
				<table class="table table-hover table-nomargin dataTable table-bordered dataTable-scroller dataTable-tools" data-ajax-source="js/plugins/datatables/demo.txt">
					<thead>
					<tr>
						<th>Rendering engine</th>
						<th>Browser</th>

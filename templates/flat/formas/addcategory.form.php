...
<form class="form-horizontal" action="/mantenimiento/agregarmenu" method="POST">
        ...
        <div class="modal-body">
           ...
           <!--  <legend>Form Components</legend> -->
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge" id="path_option" type="text" name="path_option" value=""> 
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="parametros">Parametros</label>
                <div class="controls">
                    <input class="input-xlarge" id="parametros" type="text" name="parametros" value=""> 
                </div>
            </div>

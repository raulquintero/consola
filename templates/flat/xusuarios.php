...
<head>
	...
	<title><?php echo $empresa ?> - Usuarios</title>
                    ...
                    <div class="box-content nopadding">
                        <div class="table-toolbar hidden-print">
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#modal-window" data-toggle="modal" onclick='showModal("addcurp","usuario")'>Crear Usuario</a></li>
                        ...
                        <table id="tblclientes" class="table table-hover table-nomargin table-bordered dataTable">
                            ...
                            <tbody>
                                ...
                                foreach ($response['models'] as $cliente) {
                                    ...
                                    . "<td><a class='hidden-print' href='/catalogo/usuario/" .$cliente['usuario_id'] . "/perfil'>" . ucwords($cliente_nombre) . "</a>
										<span class='visible-print'>" . ucwords($cliente_nombre) . "</span></td>"
                                    . "<td>" . $cliente['email'] . "</td>"
                                    ...
                                    . "<td class='hidden-480 hidden-print sorting_1'>
										...
										<a href='#modal-window' data-toggle='modal' onclick='showModal(\"addcurp\",\"empleado\")' class='btn' rel='tooltip' title='' data-original-title='Delete'>
                                                <i class='fa fa-times'></i>
                                        </a>
                                        </td>"
                                    . "</tr>";

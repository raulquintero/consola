			...
			<div class="user">
				<ul class="icon-nav">
					...
					<li class='dropdown language-select'>
						...
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#">
									<img src="/assets/flat/img/demo/flags/br.gif" alt="">
									<span>Brasil</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/assets/flat/img/demo/flags/de.gif" alt="">
									<span>Deutschland</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/assets/flat/img/demo/flags/es.gif" alt="">
									<span>España</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="/assets/flat/img/demo/flags/fr.gif" alt="">
									<span>France</span>
								</a>
							</li>
						</ul>
				...
				<div class="dropdown">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown">John Doe
						<img src="/assets/flat/img/demo/user-avatar.jpg" alt="">
					</a>
					<ul class="dropdown-menu pull-right">
						<li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color box-bordered lightred">
							...
							<div class="box-content nopadding">
								<form action="post.php" method="POST" class='form-horizontal form-wizard wizard-vertical' id="ssss">
									<div class="step" id="firstStep">
										<ul class="wizard-steps steps-3">
											<li class='active'>
												<div class="single-step">
									...
									<div class="step" id="secondStep">
										...
										<div class="form-content">
											...
											<div class="form-group">
												<label for="text" class="control-label col-sm-2">Language</label>
												<div class="col-sm-10">
													<select name="gend" id="gend">
														<option value="">-- Chose one --</option>
									...
									<div class="step" id="thirdStep">
										...
										<div class="form-content">
											<div class="form-group">
												<label for="text" class="control-label col-sm-2">Additional information</label>
												<div class="col-sm-10">
													<textarea name="textare" id="tt333" class="form-control" rows="10" placeholder="You can provide additional information in here..."></textarea>
												</div>
											</div>
										</div>
									</div>

...
<head>
	...
	<title><?php echo $empresa?> - Menu Superior</title>
...
<div class="page-header">
	<div class="pull-left">
		...
		<?php $menu_name = $Menu->getNameParentId($response['variables']['menu_id']); 
				if (!$menu_name) $menu_name="principal";?>
		<h1>Menu - <?php echo ucfirst($menu_name);?></h1>
	</div>
...
<div class="breadcrumbs">
	<ul>
		...
		<li>
			<a href="/mantenimiento/menu">Menu Raiz</a>
		</li>
...
<div class="row-fluid">
  <div class="span3" id="sidebar">
    ...
    <?php 
      ...
      echo "<li class=\"active\"><a href=\"/mantenimiento?sub=menu\">Menu Principal /a></li>";
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span12">
                                    <div class="table-toolbar hidden-print">
                                        <!-- <div class="btn-group ">
                                            <a href="#modal-alert" data-toggle="modal" onclick='showModal("agregarmenu",<?php echo $response['variables']['menu_id'] ?>)'>
                                                <button class="btn btn-success">Agregar Categorias <i class="icon-plus icon-white"></i></button>
                                            </a>
                                        </div> -->
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="#modal-window" data-toggle="modal" onclick='showModal("agregarmenu",<?php echo $response['variables']['menu_id'] ?>)'>Nueva</a></li>
						              ...
						              <tbody>
                                	<?php $Menu->showCategory($response['variables']['menu_id']);?>
 ...
 <div class="span12" id="content">
                    ...
                    <table class="table table-striped">
                          ...
                          <tbody>
                                  <?php $Menu->showCategoryDeleted($response['variables']['menu_id']);?>

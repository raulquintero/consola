...
<head>
	...
	<title>
					<?php echo ucwords($response['pagina']['titulo']);?>
	</title>
...
<div class="breadcrumbs">
	<ul>
		...
		<li>
			<a href="#">
					<?php echo ucwords($response['subtitulo']);?>
			</a>
		</li>
		...
		<!-- <a href="agregar_cliente" class="pull-right btn btn-blue">+ Cliente Nuevo</a> -->
                        ...
                        <div class="table-toolbar hidden-print">
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#modal-window" data-toggle="modal" onclick='showForma(0,"addcategoryproduct",0)'>Categoria Nueva</a></li>
                                    <li><a href="#modal-window" data-toggle="modal" onclick='showModal("addcurp","definir")'>Configuracion</a></li>
					...
					<table class="table table-hover table-nomargin dataTable table-bordered dataTable-scroller dataTable-tools dataTable-colreorder  hover" 
						...
						foreach ($response['models'] as $model)  {
							    echo "<tr>"
							    . "<td>" . $model['categoria_id'] . "</td>"
							    . "<td><a href='#' onclick=\"gotoURL('/productos/categorias/" . $model['categoria_id'] . "')\">" . ucwords($model['categoria']). "</a></td>"
							    . "<td><a href='#' onclick=\"gotoURL('/productos/categorias/" . $model['categoria_id'] . "')\">" . intval($model['categorias_qty']). "</a></td>"
							    . "<td><a href='#' onclick=\"gotoURL('/productos/categorias/" . $model['categoria_id'] . "')\">" . intval($model['productos_qty']). "</a></td>"
							    . "<td><a href='#' onclick=\"gotoURL('/productos/categorias/" . $model['categoria_id'] . "')\">" . intval($model['position']). "</a></td>"
								. "<td class='hidden-480 sorting_1 hidden-print'>
								        ...
								        <i class='fa fa-database'></i> Edit</a>
                                    
                                    <a href=\"#modal-window\" data-toggle=\"modal\" onclick='xRespaldo(\"dbRestaurar\",\"".$model['empresa'].$model['respaldo']."\")' class='btn'>
                                    <i class='fa fa-database'></i> Des</a>
                                    </td>"
							    . "</tr>";
							}
							?>

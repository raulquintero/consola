...
<html>
    ...
    <head>
        ...
        <title><?php echo $empresa ?> - Perfil Tienda</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="more-files.html">Perfil de la Tienda</a>
                            </li>
                        ...
                        <div class="col-sm-12">
                            <?php if (!$tienda) {
                                            ...
                                            echo '<br><br><div class="alert alert-danger alert-dismissable">
                                                    ...
                                                    <strong>Warning! </strong> No se encontraron registros coincidentes.</div>';
                                }
                                ?>
                            <div class="box box-color box-bordered <?php echo $noinfo?>">
                                <div class="box-title">
                                    <h3>
                                    ...
                                    <ul class="tabs tabs-inline tabs-top">
                                        ...
                                        <li>
                                            <a href="#notifications" data-toggle='tab'>
                                                <i class="fa fa-bullhorn"></i>Edo de Cuenta</a>
                                        </li>
                                        <li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <label for="name" class="control-label col-sm-2 right">RFC:</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="name" class='form-control' value="<?php echo ucwords($tienda['rfc']) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="apellidop" class="control-label col-sm-2 right">Tienda:</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="apellidop" class='form-control' value="<?php echo ucwords($tienda['tienda']) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="apellidom" class="control-label col-sm-2 right">Domicilio:</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="apellidom" class='form-control' value="<?php echo ucwords($tienda['domicilio']) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Email:</label>
                                                            <div class="col-sm-10">
                                                                <input readonly type="text" name="email" class='form-control' value="<?php echo $tienda['email'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Host:</label>
                                                            <div class="col-sm-10">
                                                                <input readonly type="text" name="email" class='form-control' value="<?php echo $tienda['host'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Database:</label>
                                                            <div class="col-sm-10">
                                                                <input readonly type="text" name="email" class='form-control' value="<?php echo $tienda['db'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Username:</label>
                                                            <div class="col-sm-10">
                                                                <input readonly type="text" name="email" class='form-control' value="<?php echo $tienda['username'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Password:</label>
                                                            <div class="col-sm-10">
                                                                <input readonly type="password" name="password" class='form-control' value="<?php echo $tienda['password'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-2 right" for="select01">Representante</label>
                                                            <div class="col-sm-10">
                                                                <select id="select01" class="chzn-select chzn-done" style1="display: none;" name="parent_id">
                                                                    
                                                                    <?php 
                                                                        foreach ($representantes as $representante){
                                                                            if ($representante['cliente_id'] == $tienda['cliente_id']) { $selected = "selected";} else {$selected="";}
                                                                            echo "<option $selected value=".$representante['cliente_id']."'>".$Cliente->getFullName($representante)."</option>";
                                                                        }
                                                                    ?>

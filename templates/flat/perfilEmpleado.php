...
$empleado_nombre= strtoupper($response['model']['nombre'].' '.$response['model']['apellidop'].' '.$response['model']['apellidom']);
            ...
            <div id="main">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="pull-left">
                            <h1 class=><?php echo ucwords($response['page_subtitle']) ?></h1>
                        </div>
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo $response['page_parent_url'] ?>"><?php echo ucwords($response['page_parent']) ?></a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                            ...
                            <div class="box box-color box-bordered green">
                                ...
                                <div class="box-content nopadding">
                                    <ul class="tabs tabs-inline tabs-top">
                                        ...
                                        <li>
                                            <a href="#security" data-toggle='tab'>
                                                <i class="fa fa-lock"></i>Actas Administrativas</a>
                                        </li>
                                        <?php }?>
                                    </ul>
                                    ...
                                    <div class="tab-content padding tab-content-inline tab-content-bottom">
                                        <div class="tab-pane active" id="profile">
                                            ...
                                            <form id="formulario" action="<?php echo $response['form_action'] ?>/person"  method="POST" class="form-horizontal form-validate">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10" >
                                                            <?php if(!$response['model']['curp']) $response['model']['curp']=$_POST['curp']?>
                                                                <input disabled type="text" name="curp" class='form-control disabled' value="<?php echo strtoupper($response['model']['curp']) ?>" <?php echo $style_white?> >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="nombre"  data-rule-required="true" class='form-control' value="<?php echo strtoupper($response['model']['nombre']) ?>" <?php echo $style_white?> >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="apellidop" class="control-label col-sm-2 right">Apellido P:</label>
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="apellidop" class='form-control' value="<?php echo strtoupper($response['model']['apellidop']) ?>" <?php echo $style_white?> >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="apellidom" class="control-label col-sm-2 right">Apellido M:</label>
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="apellidom" class='form-control' value="<?php echo strtoupper($response['model']['apellidom']) ?>"<?php echo $style_white?> >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Email:</label>
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="email" class='form-control' value="<?php echo $response['model']['email'] ?>" <?php echo $style_white?>>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="telmovil" class="control-label col-sm-2 right">Movil</label>
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="telmovil" id="telmovil" class="form-control mask_phone" data-rule-required="true" value="<?php echo $response['model']['telmovil'] ?>" <?php echo $style_white?>>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="telcasa" id="telcasa" class="form-control mask_phone" value="<?php echo $response['model']['telcasa'] ?>" <?php echo $style_white?>>
                                                                <span class="help-block">Format: (999) 999-9999</span>
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="cp" class='form-control' value="<?php echo strtoupper($response['model']['cp']) ?>" <?php echo $style_white?>>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email" class="control-label col-sm-2 right">Domicilio:</label>
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="domicilio" class='form-control' value="<?php echo strtoupper($response['model']['domicilio']) ?>" <?php echo $style_white?>>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select <?=$response['readonly']?> name="colonia_id" id="select" class="form-control" <?php echo $style_white?>>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input <?=$response['readonly']?> type="text" name="fecha_nac" id="fecha_nac" class="form-control mask_date"  value="<?php echo $response['model']['fecha_nac'] ?>" <?php echo $style_white?> >
                                        ...
                                        <div class="tab-pane" id="notifications">
                                            ...
                                            <form action="<?php echo $response['form_action'] ?>/empleado"   method="POST"  class="form-horizontal">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                            ...
                                                            Solicitudes<br>
                                                            <?php 
                                                            foreach ($response['solicitudesempleo'] as $solicitudempleo) {
                                                                echo $solicitudempleo['created_at']."<br>";
                                                            }
                                                             ?>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="text" class="control-label col-sm-2">Puesto </label>
                                                            <div class="col-sm-2">
                                                                <select  <?=$response['readonly']?> name="puesto_id" id="puesto_id" data-rule-required="true">
                                                                    ...
                                                                    <?php 
                                                                        foreach ($response['puestos'] as $puesto) {
                                                                            ...
                                                                            echo "<option value='".$puesto['puesto_id']."' $selected>".$puesto['puesto']."</option>";
                                                        ...
                                                        <div class="form-group">
                                                            <label for="text" class="control-label col-sm-2">Horario </label>
                                                            <div class="col-sm-2">
                                                                <select  <?=$response['readonly']?> name="horario_id" id="horario_id" data-rule-required="true">
                                                                    <!-- <option value="x">-- Chose one --</option> -->
                                                                    <?php 
                                                                        foreach ($response['horarios'] as $horario) {
                                                                            if($response['model']['horario_id']==$horario['horario_id']) $selected = " selected "; else $selected = "";
                                                                            echo "<option value='".$horario['horario_id']."' $selected>".ucwords($horario['horario'])."</option>";
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea id="oficios" name="oficios" id="tt333" class="form-control" rows="7" placeholder="Oficios que domina"><?php echo strtoupper($response['model']['oficios']) ?></textarea>
                                                            </div>
                                                        </div>

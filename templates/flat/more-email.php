			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="more-footer.html">Site with Footer</a>
						</li>
					</ul>
						...
						<div class="box">
							...
							<div class="box-content">
								<div class="alert alert-info">
									FLAT supports many different Email color templates. You can also simply create your own color template! These Email Templates are based on the
									<a href="http://htmlemailboilerplate.com/">HTML Email Boilerplate</a>.
								</div>
								<h5>Please select a color</h5>
								<ul class="colors">
									<li class='red'>
										<a href="emails/email-red.html"></a>
									</li>
									<li class='orange'>
										<a href="emails/email-orange.html"></a>
									</li>
									<li class='green'>
										<a href="emails/email-green.html"></a>
									</li>
									<li class="brown">
										<a href="emails/email-brown.html"></a>
									</li>
									<li class="blue">
										<a href="emails/email-blue.html"></a>
									</li>
									<li class='lime'>
										<a href="emails/email-lime.html"></a>
									</li>
									<li class="teal">
										<a href="emails/email-teal.html"></a>
									</li>
									<li class="purple">
										<a href="emails/email-purple.html"></a>
									</li>
									<li class="pink">
										<a href="emails/email-pink.html"></a>
									</li>
									<li class="magenta">
										<a href="emails/email-magenta.html"></a>
									</li>
									<li class="grey">
										<a href="emails/email-grey.html"></a>
									</li>
									<li class="darkblue">
										<a href="emails/email-darkblue.html"></a>
									</li>
									<li class="lightred">
										<a href="emails/email-lightred.html"></a>
									</li>
									<li class="lightgrey">
										<a href="emails/email-lightgrey.html"></a>
									</li>
									<li class="satblue">
										<a href="emails/email-satblue.html"></a>
									</li>
									<li class="satgreen">
										<a href="emails/email-satgreen.html"></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-sm-12">
						<div class="box">
							...
							<div class="box-content">
								...
								<a href="emails/email-newsletter.html" class='btn btn-satblue'>Newsletter</a>
								<a href="emails/email-products.html" class='btn btn-lightred'>New products</a>
								<a href="emails/email-offer.html" class='btn btn-satgreen'>Special offer</a>
							</div>
						</div>
					</div>
				</div>

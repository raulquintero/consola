					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content">
							...
							<form action="#" method="POST" class='form-vertical'>
								<div class="row">
                                    <div class="col-sm-2">
                                        <div class="fileinput fileinput-new" data-provides="fileinput"><?=strtoupper($cliente_nombre)  ?><br>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['curp'])?>" >
										</div>
									</div>
                                </div>
                                <div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['nombre'])?>">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<label for="textfield" class="control-label">Apellido Paterno</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['apellidop'])?>">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<label for="textfield" class="control-label">Apellido Materno</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['apellidom'])?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-2">
										<div class="form-group">
											...
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['cp'])?>">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label for="textfield" class="control-label">Domicilio</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['domicilio'])?>">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<label for="textfield" class="control-label">Colonia</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['colonia'])?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['telmovil'])?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<label for="textfield" class="control-label">Tel. Casa</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['telcasa'])?>">
										</div>
									</div>
                                    <div class="col-sm-6">
										<div class="form-group">
											<label for="textfield" class="control-label">Email</label>
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control"  value="<?php echo strtoupper($response['model']['email'])?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-2">
										<div class="form-group">
											...
											<input <?php echo $response['readonly']?> type="text" name="textfield" id="textfield" placeholder="Text input" class="form-control" value="<?php echo strtoupper($response['model']['fecha_nac'])?>">
										</div>
									</div>
								</div>
                                <div class="form-actions">
                                <?php
                                    if ($response['model']['person_id'] && $response['model']['curp']){
                                        echo '<button onclick="redirect(\'hola\',\'none\')" class="btn btn-primary">Continuar</button>';

                                    } 
                                    if ($response['model']['curp'] && !$response['model']['person_id']) {
                                        echo '<input type="submit" class="btn btn-primary" value="Grabar">';

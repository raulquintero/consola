                    ...
                    <div class="box-content nopadding">
                        <div class="table-toolbar hidden-print">
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#modal-window" data-toggle="modal" onclick='showModal("addcurp","cliente")'>Crear Cliente</a></li>
                        ...
                        <table id="tblclientes" class="table table-hover table-nomargin table-bordered dataTable">
                            ...
                            <tbody>
                                ...
                                if(!$response['clientes']['error'])
                                foreach ($response['models'] as $cliente)  {
                                    $cliente_nombre = $cliente['apellidop'] . " " . $cliente['apellidom'] . " " . $cliente['nombre'];
                                    echo "<tr>"
                                    . "<td>" . $cliente['cliente_id'] . "</td>"
                                    . "<td><a href='/catalogo/cliente/" . $cliente['cliente_id'] . "/perfil'>" . ucwords($cliente_nombre) . "</a></td>"
                                    . "<td>" . $cliente['email'] . "</td>"
                                    . "<td>" . $cliente['path_option'] . "</td>"

...
<head>
	...
	<!-- gmap -->
	<link rel="stylesheet" href="css/plugins/gmap/gmap3-menu.css">
	<!-- Theme CSS -->
						...
						<div class="box">
							...
							<div class="box-content">
								<div class="alert alert-info">
									<h4>Information!</h4>
									<p>Right-click on the map to get menu.</p>
								</div>
								<div id="map2"></div>
							</div>
						</div>
					...
					<div class="col-sm-12">
						<div class="box">
							...
							<div class="box-content">
								<div class="alert alert-info">
									<h4>Information!</h4>
									<p>This map is useful when you have A LOT of markers.
										<strong>Tip:</strong>You can click on the clusters to zoom to that cluster.</p>
								</div>
								<div id="map3"></div>
							</div>
						</div>

...
<head>
	...
	<title>FLAT - Mobile sidebar with button</title>
		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>Mobile sidebar with button</h1>
					</div>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="layouts-mobile-button.html">Mobile sidebar with button</a>
						</li>
					</ul>
					...
					<div class="col-sm-12">
						<div class="box">
							...
							<div class="box-content">
								Try this page in your mobile device and just click the button on the top left corner to toggle the sidebar.
							</div>
						</div>
					</div>
				</div>

					...
					<div class="col-sm-6">
						<div class="box">
							...
							<div class="box-content">
								<div id="flot-radar" class='flot'></div>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="box">
							...
							<div class="box-content">
								<div id="flot-spider" class='flot'></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							...
							<div class="box-content">
								<p>
									<strong>Set custom update interval (ms):</strong>
									<input type="text" name="updateInterval" id="updateInterval" class='input-mini'>
									<a href="javascript:void()" class='btn'>Set interval</a>
								</p>

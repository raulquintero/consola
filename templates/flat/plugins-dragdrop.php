...
<body>
	...
	<div class="container-fluid" id="content">
		...
		<div id="main">
			<div class="container-fluid sortable-box">
				<div class="page-header">
					<div class="pull-left">
						<h1>Drag &amp; Drop widgets</h1>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="box box-color box-bordered orange">
							...
							<div class="box-content">
								Lorem ipsum Ad aute ut in pariatur ad consectetur.
							</div>
						</div>
						<div class="box box-color box-bordered brown">
							...
							<div class="box-content">
								Lorem ipsum Voluptate aliquip minim veniam dolore dolore proident nostrud quis ullamco.
							</div>
						</div>
					...
					<div class="col-sm-4">
						<div class="box box-color box-bordered magenta">
							...
							<div class="box-content">
								Lorem ipsum Dolore in aute sint exercitation consectetur in qui quis in laboris sit adipisicing.
							</div>
						</div>
						<div class="box box-color box-bordered lightgrey">
							...
							<div class="box-content">
								Lorem ipsum Non Duis sint tempor dolore eu dolor enim ea nisi exercitation officia.
							</div>
						</div>
						<div class="box box-color box-bordered purple">
							<div class="box-title">
								<h3>
									<i class="fa fa-file"></i>
									Widget #9
							...
							<div class="box-content">
								Lorem ipsum Voluptate magna aute ut sunt est do consequat officia ex in dolore elit.
							</div>
						</div>
					</div>
				</div>

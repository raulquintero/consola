...
<head>
	...
	<title>FLAT - Mobile sidebar with slide</title>
		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>Mobile sidebar with slide</h1>
					</div>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="layouts-mobile-slide.html">Mobile sidebar with slide</a>
						</li>
					</ul>
					...
					<div class="col-sm-12">
						<div class="box">
							...
							<div class="box-content">
								Try this page in your mobile device and slide from left to right to show the navigation. Sliding from right to left will hide it.
							</div>
						</div>
					</div>
				</div>

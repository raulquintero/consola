...
<head>
	...
	<title><?php echo $empresa ?> Access Denied</title>
			...
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left red">
						<h1><font color=red><Strong>Error 401:</strong> Acceso Restringido</font></h1>
					</div>
...
<br><br> <ul>
				La pagina que has intentado ver , se encuentra restringida consulta con el adminstrador para aclarar cualquier duda.
<br><br><Br>
...
<img class="publicidad" src="http://www.fincasortiz.com/Resources/imagenes/denegado.png" height=300 align=right>
